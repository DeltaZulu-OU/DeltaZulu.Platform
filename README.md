...
- Settings persistence code paths were refactored for clarity (centralized SQL constants/helpers and explicit normalization in `UserSettingsState`) with no behavior change.
