...
public sealed class CanonicalPathResolverTests
{
    ...
    public void Resolve_DetectionMetadata_ProducesCorrectPath()
    {
        ...
        Assert.AreEqual("detections/anomalous-sign-in.yaml", result);
    }
    ...
    public void ExtractDetectionSlug_FromValidPath_ReturnsSlug() => Assert.AreEqual("anomalous-sign-in",
            CanonicalPathResolver.ExtractDetectionSlug("detections/anomalous-sign-in.yaml"));

    [TestMethod]
    public void ExtractDetectionSlug_FromNestedPath_ReturnsSlug() => Assert.AreEqual("brute-force-spray",
            CanonicalPathResolver.ExtractDetectionSlug("detections/brute-force-spray.yaml"));
