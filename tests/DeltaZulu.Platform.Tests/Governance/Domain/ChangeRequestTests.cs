...
public sealed class ChangeRequestTests
{
    ...
    private static void SeedPackage(ChangeRequest c)
    {
        ...
        c.UpsertDraftFile(LogicalPath.Parse("rule.kql"), DraftContentType.AnalyticsQuery, "SigninLogs | take 1", Author, T0);
    }
    ...
    public void MergedChange_CannotBeEdited()
    {
        ...
        var ex = Assert.ThrowsExactly<DomainException>(() =>
            c.UpsertDraftFile(LogicalPath.Parse("rule.kql"), DraftContentType.AnalyticsQuery, "x", Author, T0));
