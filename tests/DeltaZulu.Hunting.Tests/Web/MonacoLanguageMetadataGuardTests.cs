...
public sealed class MonacoLanguageMetadataGuardTests
{
    ...
    {
        var source = ReadRepositorySource("src", "DeltaZulu.Hunting.Web.Legacy", "wwwroot", "js", "monaco.js");
    ...
    {
        var source = ReadRepositorySource("src", "DeltaZulu.Hunting.Web.Legacy", "Services", "LanguageService.cs");
