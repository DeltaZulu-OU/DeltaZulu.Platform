...
public sealed class MonacoLanguageMetadataGuardTests
{
    ...
    {
        var source = ReadRepositorySource("src", "DeltaZulu.Hunting.Web", "wwwroot", "js", "monaco.js");
    ...
    {
        var source = ReadRepositorySource("src", "DeltaZulu.Hunting.Web", "Services", "LanguageService.cs");
