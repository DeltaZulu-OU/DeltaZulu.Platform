...
Accepted. Supersedes [ADR 0003](0003-schema-medallion-and-provenance.md) where the two conflict. Extended by [ADR 0014](0014-type-fidelity-registry-and-avro-arrow-ingestion.md) for wire-format and logical-type fidelity.
...
- Drift checks should cover DuckDB/DuckLake, Proton, Avro, Arrow, and KQL metadata generation from the shared schema catalog.
