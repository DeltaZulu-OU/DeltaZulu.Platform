...
public sealed class DapperSavedQueryRepository : ISavedQueryRepository
{
    ...
    public async Task<IReadOnlyList<SavedQueryRecord>> ListAsync(CancellationToken cancellationToken = default)
    {
    ...
    public async Task<SavedQueryRecord?> GetAsync(string id, CancellationToken cancellationToken = default)
    {
    ...
    public async Task SaveAsync(SavedQueryRecord query, CancellationToken cancellationToken = default)
    {
    ...
    private static SavedQueryRecord ToRecord(SavedQueryRow row)
    {
