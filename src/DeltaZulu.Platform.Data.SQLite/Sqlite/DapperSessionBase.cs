...
namespace DeltaZulu.Platform.Data.Sqlite;
...
/// </summary>
public abstract class DapperSessionBase : IUnitOfWork, IDisposable
{
    public SqliteConnection Connection { get; }
    public SqliteTransaction? Transaction { get; private set; }

    protected DapperSessionBase(string connectionString)
    {
